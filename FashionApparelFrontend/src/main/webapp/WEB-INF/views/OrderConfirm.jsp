...
<div class="container">
<div style="background-color:blue"><h2 align="center">Your Cart</h2></div>
    <div class="row">
                ...
                <form action="<c:url value="/updateCartItem/${cartItem.cartItemId}"/>" method="get">
                    ...
                    <tr>
                        ...
                        <a href="<c:url value="/cart"/>" class="btn btn-default">
                            <span class="glyphicon glyphicon-shopping-cart"></span> Edit CartItems
                        </a></td>
                        <td>
                        <a href="<c:url value="/payment"/>"  class="btn btn-success">
